...
const SignInScreen = () => {
  ...
  return (
    <SafeAreaView className='flex-1 bg-primary dark:bg-secondary' edges={["top"]}>
      <View className='absolute -left-16 top-14 h-56 w-56 rounded-full bg-primary/80 dark:bg-background/40'/>
      <View className='absolute -right-16 top-40 h-56 w-56 rounded-full bg-secondary/70 dark:bg-background/35'/>
      <View className='px-6 pt-4'> 
        <Text className='text-center text-5xl font-extrabold tracking-tight text-primary-foreground dark:text-foreground'>
          Grocify
        </Text> 
         <Text className='mt-1 text-center text-[14px] tracking-tight text-primary-foreground/80 dark:text-foreground/75'>
        ...
        <View className='self-center rounded-full bg-secondary px-3 py-1'>
          <Text className='text-xs font-semibold uppercase tracking-[1px] text-secondary-foreground'>
           ...
           <Text className='mt-2 text-center text-sm leading-6 text-muted-foreground'>
            Choose a social provider and jump into your personalized grocery experience.  
          </Text> 
